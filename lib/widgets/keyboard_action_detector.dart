...
class KeyboardActionDetector extends StatelessWidget {
  const KeyboardActionDetector({Key? key, required this.child, required this.onArrowDownCallback, required this.onArrowUpCallback, required this.onArrowLeftCallback, required this.onArrowRightCallback,}) : super(key: key);
  ...
  _initShortcuts() => <LogicalKeySet, Intent>{
    ...
    LogicalKeySet(LogicalKeyboardKey.arrowRight): const _XIntent.arrowRight(),
  };
